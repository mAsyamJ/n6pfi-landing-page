...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "NapFi's modular architecture transformed how we think about yield aggregation. The AI optimization alone saves us thousands in gas fees monthly.",
      name: "Alex Chen",
      company: "Co-founder, DeFi Labs",
      image:
    ...
    {
      quote:
        "The revenue tokenization feature is a game-changer for creators. We can now offer our community direct ownership in our yield streams.",
      name: "Jordan Rivera",
      company: "Creator, Music DAO",
      image:
    ...
    {
      quote:
        "NapFi's EAS attestations give us the transparency and verifiability we need for institutional capital. This is the future of DeFi.",
      name: "Morgan Park",
      company: "Head of Strategy, Venture Fund",
      image:
